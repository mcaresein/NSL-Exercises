...
double variationalWaveFunction(double v)
{
	...
	double _mu=0.79;
	double _sigma=0.62;
	return exp(-(v-_mu)*(v-_mu)/(2*_sigma*_sigma)) + exp(-(v+_mu)*(v+_mu)/(2*_sigma*_sigma));
...
double variationalWaveFunction_second(double x)
{
	...
	double _mu=0.79;
	double _sigma=0.62;
	return exp(-(x -_mu)*(x -_mu)/(2*_sigma*_sigma))*( -1 + (x -_mu)*(x -_mu)/_sigma/_sigma )/_sigma/_sigma + exp(-(x +_mu)*(x +_mu)/(2*_sigma*_sigma))*( -1 + (x +_mu)*(x +_mu)/_sigma/_sigma )/_sigma/_sigma;
